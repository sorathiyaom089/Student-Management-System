"""
1. Initializing currentSum to 0 causes the function to return 0 for arrays with all negative numbers, which is incorrect since the maximum subarray sum should be the largest (least negative) element.
